...
SIGN_IN_LINK = f"https://payment.ivacbd.com//{EMBASSY}/niv/users/sign_in"
APPOINTMENT_URL = f"https://payment.ivacbd.com//{EMBASSY}/niv/schedule/{SCHEDULE_ID}/appointment"
DATE_URL = f"https://payment.ivacbd.com//{EMBASSY}/niv/schedule/{SCHEDULE_ID}/appointment/days/{FACILITY_ID}.json?appointments[expedite]=false"
TIME_URL = f"https://payment.ivacbd.com//{EMBASSY}/niv/schedule/{SCHEDULE_ID}/appointment/times/{FACILITY_ID}.json?date=%s&appointments[expedite]=false"
SIGN_OUT_LINK = f"https://payment.ivacbd.com//{EMBASSY}/niv/users/sign_out"
